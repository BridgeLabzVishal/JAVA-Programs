...
public class StockLinkedList<T> {
	...
	private static final String PATH_COMPANY = "/home/user/eclipse-workspace/Oops/src/com/bridgelabz/stockmanagement/repository/Company.json";
	...
	public void add() {
		...
		long noOfShares = InputUtility.nextlong();
