...
import com.bridgelabz.stockmanagement.model.BuyerModel;
import com.bridgelabz.stockmanagement.model.Model;
import com.bridgelabz.stockmanagement.model.SellerModel;
import com.bridgelabz.utility.InputUtility;
import com.bridgelabz.utility.Utility;

public class ServicesImplementation extends StockAccount implements IServices {
	private static final String PATH_STOCK = "/home/user/eclipse-workspace/Oops/src/com/bridgelabz/stockmanagement/repository/Stock.json";
	...
	public void buy(int amount, String companySymbol) {
		...
		buyer.setName(InputUtility.next());
...
//			stock.queueTransaction();
	...
	public void sell(int amount, String companyName) {
		...
		seller.setName(InputUtility.next());
